#!/bin/bash
#SBATCH -J llama31_forget
#SBATCH -o logs/llama31_npo_%j.out
#SBATCH -e logs/llama31_npo_%j.err
#SBATCH -p compute
#SBATCH -N 1
...
WEIGHT_DECAY="0.01"
BETA=0.2
LAMBDA=0.15        # 这里对应 grad_diff_coeff
LR=1e-5

BASE_SAVE_ROOT="/home/zkzhang/unlearning/Unlearn-Simple/TOFU/unlearned/llama31_forget"
...
echo "=========================================================="
echo "RUN: lr=${LR}, beta=${BETA}, lambda=${LAMBDA}"
...
echo "All forget finished. Results under: ${BASE_SAVE_ROOT}"
